  ...
  color: white;
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="{{ route('home')}}">Anasayfa</a>
            <a class="navbar-brand" href="{{ route('adminpanel')}}">Panel Anasayfa</a>
            ...
            <main>
                ...
                <table id="tablo">
                    ...
                    <tr>
                        ...
                        <form method="GET" action="{{route('yetki-guncelle', $user->id)}}">
                        <td>
                        <select id="tablo" name="yetki" value="{{$user->id}}">
                        ...
                        <td>
                        <a href="{{route('kullanici-sil', $user->id)}}"><button>Sil</button></a>
                        </td>
                    </tr>
                    @endforeach
                </table>
