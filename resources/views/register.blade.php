                ...
                {{ csrf_field() }}
                    ...
                    <div class="login-form-body">
                        <div class="form-group">
                            <label>Ad</label>
                            <input class="au-input au-input--full" type="text" name="name" placeholder="Adınız">
                        </div>
                        <div class="form-group">
                            <label>E-Posta Adresi</label>
                            <input class="au-input au-input--full" type="email" name="email" placeholder="E-Posta Adresiniz">
                        </div>
                        <div class="form-group">
                            <label>Kullanıcı Adı</label>
                            <input class="au-input au-input--full" type="text" name="username" placeholder="Kullanıcı Adınız">
                        </div>                                
                        <div class="form-group">
                            <label>Şifre</label>
                        ...
                        <p class="text-muted">Hesabın var mı?<a href="{{ route('login.show') }}">Giriş Yap</a></p>
                        </div>
                    </div>
                </form>
            </div>
